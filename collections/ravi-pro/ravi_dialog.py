...
class RAVIDialog(QDialog, FORM_CLASS):
    ...
    def initial_processing(self):
        ...
        """
        Lists all files within the 'areas' subfolder of the plugin directory.

        Returns:
            List[str]: List of file paths within the 'areas' subfolder.
        """
        plugin_dir = os.path.dirname(__file__)
        areas_dir = os.path.join(plugin_dir, "areas")
        if not os.path.exists(areas_dir):
            print(f"'areas' subfolder not found at: {areas_dir}")
            return []
        ...
        print("Files found in 'areas' subfolder:")
        for path in file_paths:
            print(path)
        
        for gpkg_path in file_paths:
            if gpkg_path.lower().endswith('.gpkg'):
                ...
                if layer.isValid():
                    ...
                    print(f"Failed to load: {gpkg_path}")
